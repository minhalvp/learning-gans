...
# Comparing GPU and CPU training times
epoch_time = []
epoch_nums = [x + 1 for x in range(num_epochs)]
print(epoch_nums)
for epoch in range(num_epochs):
    ...
    plt.title("Time taken to complete an Epoch on a CPU")
    plt.xlabel("Epoch")
    plt.ylabel("Time (s)")
    plt.plot(epoch_nums, epoch_time)
    plt.show()